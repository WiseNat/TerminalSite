...
export const DEFAULT_USER_PROMPT = "C:\\src\\main\\nathanwise>"; // NOSONAR
export const COMMAND_NOT_FOUND = ": command not found";
export const DEFAULT_CURRENT_WORKING_DIRECTORY = "/src/main/nathanwise";
export const DEFAULT_HOME_DIRECTORY = "/src/main/nathanwise";
